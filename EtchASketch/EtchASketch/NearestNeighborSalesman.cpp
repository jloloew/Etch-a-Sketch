...
void etchasketch::salesman::NearestNeighborSalesman::orderPoints()
{
...
void etchasketch::salesman::NearestNeighborSalesman::nearestNeighborAlgorithm(KDTree<2> &kdTree)
{
	...
	while (!unorderedPoints.empty()) {
		...
		KDPoint<2> *currPoint = kdTree.findNearestNeighbor(orderedPoints.back());
