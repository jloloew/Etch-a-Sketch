	...
	namespace salesman {
		...
		private:
			// Create our undirected graph types.
                  typedef boost::adjacency_list<boost::hash_setS,
                                                boost::hash_setS,
                                                boost::undirectedS, KDPoint<2>>
                      UndirectedGraph;
                  typedef boost::graph_traits<UndirectedGraph>::vertex_iterator
                      VertexIterator;
                  typedef boost::graph_traits<
                      UndirectedGraph>::vertex_descriptor VertexDesc;
                   ...
                   * ordered points.
                   */
                  void walkDFS(const UndirectedGraph &g,
